    ...
    (() => {
                ...
                if (!selectOptions.classList.contains("_slide")) {
                    if (originalSelect.multiple) {
                        ...
                        if (!originalSelect.hasAttribute("data-show-selected")) setTimeout((() => {
                            ...
                            const list = document.querySelectorAll(".select__option");
                            list.forEach((listItem => {
                                listItem.classList.remove("_choosed");
                            }));
                            optionItem.classList.add("_choosed");
                        }
        ...
        function initSliders() {
            ...
            if (document.querySelector(".product-gallery")) {
                const sliderThumbs = new core(".product-gallery__slider-thumbs", {
            ...
            if (document.querySelector(".content-gallery")) {
                const sliderThumbs = new core(".content-gallery__slider-thumbs", {
                    modules: [ Navigation, Thumb ],
                    slidesPerView: "auto",
                    spaceBetween: 20,
                    freeMode: true,
                ...
                new core(".content-gallery__slider", {
                    modules: [ Navigation, Thumb ],
                    slidesPerView: 1,
                    spaceBetween: 32,
                    mousewheel: true,
